...
export class HtmlUtil {
   ...
   public static uid(value) {
      ...
      if (uuid == null) {
         uuid = value.__puuid = RuntimeUtil.nextId('html');
      }
      return uuid;
   }
   ...
   // @param value 对象
   //==========================================================
   public static link(hTag: HTMLElement, value: any) {
      (hTag as any).__linker = value;
   }
   ...
   // @return 对象
   //==========================================================
   public static searchLinker(hTag: HTMLElement, clazz: Function) {
      while (hTag) {
         var linker = (hTag as any).__linker;
         if (linker) {
            if (linker instanceof clazz) {
               return linker;
            }
         }
   ...
   // @return 页面元素
   //==========================================================
   public static searchElement(hTag: HTMLElement, value: any) {
      while (hTag) {
         var linker = (hTag as any).__linker;
         if (linker == value) {
            return hTag;
   ...
   // @param hTag 页面对象
   //==========================================================
   public static focus(hTag: HTMLElement) {
      if (hTag) {
         if (hTag.focus) {
            hTag.focus();
         }
   ...
   // @param item 项目
   //==========================================================
   public static dispose(item: any): any {
      if (item) {
