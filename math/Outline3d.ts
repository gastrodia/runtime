...
// @version 141231
//==========================================================
export class Outline3d extends Outline3 {
   //..........................................................
   // @attribute 中心点
   public center: Vector3 = new Vector3();
   public distance: Vector3 = new Vector3();
   // @attribute 半径
   public radius = 0;
   // @attribute 顶点集合
   ...
   // @method
   //============================================================
   public calculateFrom(outline, matrix) {
      var o = this;
      // 计算顶点数据
      var points = o.points;
   ...
   public calculate(p) {
      var o = this;
      // 计算空间内位置
      var vix = Number.MAX_VALUE;
      var viy = Number.MAX_VALUE;
      var viz = Number.MAX_VALUE;
      var vax = -Number.MAX_VALUE;
      var vay = -Number.MAX_VALUE;
      var vaz = -Number.MAX_VALUE;
      var i = 0;
      var d = o.points;
      while (i < 24) {
         var x = d[i++];
